package unican.es.grupo4_tus_santander.Aceptacion;
...
public class LineasActivityTest1 {

    @Rule
    public ActivityTestRule<LineasActivity> mActivityTestRule = new ActivityTestRule<>(LineasActivity.class);

    @Test
    public void lineasActivityTest1() {
